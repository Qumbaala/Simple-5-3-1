...
import com.crookedqueue.simple531remake.Presenter.MaxManagerPresenter;
...
public class ManuallyEditMaxDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_manually_edit_max_dialog, null);
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (inputIsValid()) {
                    double max = getMaxFromDialog(Double.parseDouble(editWeight.getText().toString()),
                            Integer.parseInt(editReps.getText().toString()), true);
