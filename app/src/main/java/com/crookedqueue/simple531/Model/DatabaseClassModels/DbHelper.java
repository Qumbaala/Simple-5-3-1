...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_MAXES_TABLE = "CREATE TABLE " + MAXES_TABLE_NAME + "(" + COLUMN_SQUAT_MAX + " REAL DEFAULT 0," + COLUMN_BENCH_MAX + " REAL," + COLUMN_DEADLIFT_MAX + " REAL DEFAULT 0," + COLUMN_PRESS_MAX + " REAL DEFAULT 0," + COLUMN_MAXES_DATE + " INTEGER PRIMARY KEY DEFAULT " + System.currentTimeMillis() + ")";
